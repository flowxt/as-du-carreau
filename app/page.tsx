    ...
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center pt-32 pb-20">
          <HeroFadeIn delay={0.3} y={30}>
            <Image
              ...
              width={700}
              height={280}
              className="mx-auto w-full max-w-md md:max-w-lg lg:max-w-2xl h-auto mb-8"
              priority
            />
          </HeroFadeIn>
          ...
          <HeroFadeIn delay={0.8}>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-4 font-light text-charcoal">
              Plus de 20 ans d&apos;expérience au service de vos projets.
            </p>
          </HeroFadeIn>

          <HeroFadeIn delay={1.0}>
            <p className="text-lg max-w-2xl mx-auto mb-4 text-charcoal/70">
              Carrelage, faïence, mosaïque, douches à l&apos;italienne, salles de bain et extérieurs.
            </p>
            <p className="text-xl md:text-2xl font-serif italic mb-6 text-gold">
              La précision d&apos;un artisan, la passion d&apos;un métier.
            </p>
          </HeroFadeIn>

          <HeroFadeIn delay={1.2}>
            <div className="inline-flex items-center gap-4 mb-12 px-6 py-3 border border-charcoal/15">
              <span className="font-medium text-charcoal">Professionnels</span>
              <span className="text-charcoal/40">&amp;</span>
              <span className="font-medium text-charcoal">Particuliers</span>
            </div>
          </HeroFadeIn>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <FadeIn delay={0.3}>
            <p className="text-center text-black mt-12 max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16" staggerDelay={0.08}>
            {engagements.map((item, index) => (
              <StaggerItem key={index}>
                <div className="group/eng flex items-center gap-4 p-5 border border-charcoal/10 hover:border-gold/30 transition-all duration-300 cursor-default">
                  <div className="w-8 h-8 bg-gold/15 group-hover/eng:bg-gold flex items-center justify-center flex-shrink-0 transition-all duration-300">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto" staggerDelay={0.08}>
            {[
              ...
              <StaggerItem key={index}>
                <div className="group/eng2 flex items-center gap-4 text-charcoal cursor-default">
                  <div className="w-6 h-6 bg-gold/15 group-hover/eng2:bg-gold flex items-center justify-center flex-shrink-0 transition-all duration-300">
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden bg-cream">
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <FadeIn>
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-8 leading-tight text-charcoal">
          ...
          <FadeIn delay={0.2}>
            <div className="separator separator-center mb-8"></div>
            <p className="text-xl mb-10 max-w-2xl mx-auto text-black">
